...
namespace ScheduledProcesing.Tests.Customers.UnitTests.Infrastructure.Persistence
{
    ...
    public class CustomerRepositoryTests
    {
        ...
        {
            // arrange
            var existinCustomer = Fakes.Customers.Valid().Generate();
        ...
        {
            // arrange
            var existingCustomer = Fakes.Customers.Valid().Generate();
            using var customersContext = CustomersContextMockBuilder
