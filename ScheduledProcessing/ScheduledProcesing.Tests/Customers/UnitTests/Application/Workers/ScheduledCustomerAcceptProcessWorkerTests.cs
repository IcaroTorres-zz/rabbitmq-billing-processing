...
namespace ScheduledProcesing.Tests.Customers.UnitTests.Application.Workers
{
    ...
    public class ScheduledCustomerAcceptProcessWorkerTests
    {
        ...
        public void BuildConsumer_Should_Create_EventingBasicConsumer()
        {
            ...
            // act
            var result = sut.BuildConsumer(channelMock.Object, expectedQueuename);
        ...
        [Fact]
        public void DoExecute_Should_Succeed()
        {
            // arrange
            const string expectedQueuename = "sample";
            MockBuildConsumerDependencies(
            ...
            // act
            var result = sut.DoExecute(expectedQueuename);
        ...
        [Fact]
        public async System.Threading.Tasks.Task WriteCustomersMessage_Should_GenerateDeserializableMathingCustomersAsync()
        {
            // arrange
            var expectedCustomers = Fakes.Customers.Valid().Generate(2);
